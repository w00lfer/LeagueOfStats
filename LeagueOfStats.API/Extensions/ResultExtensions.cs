...
{
    public static async Task<IActionResult> ToIActionResult(
    ...
    public static async Task<IActionResult> ToIActionResult<T>(
    ...
    private static IActionResult GetActionResultBasedOnErrorType(
        Error[] errors,
        ControllerBase controllerBase)
    {
