...
public class SummonerChampionMasteryConfiguration : EntityConfigurationBase<SummonerChampionMastery>, IEntityTypeConfiguration<SummonerChampionMastery>
{
    public void Configure(EntityTypeBuilder<SummonerChampionMastery> builder)
    {
        ConfigureDefaultProperties(builder);

        builder.Property(scm => scm.ChampionId);
